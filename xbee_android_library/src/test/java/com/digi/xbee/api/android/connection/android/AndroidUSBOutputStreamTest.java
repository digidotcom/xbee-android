...
public class AndroidUSBOutputStreamTest {
	...
	/**
	 * Test method for {@link AndroidUSBOutputStream#write(int)}
	 *
	...
	/**
	 * Test method for {@link AndroidUSBOutputStream#write(byte[])}
	 *
	...
	/**
	 * Test method for {@link AndroidUSBOutputStream#write(byte[], int, int)}
	 *
	 * <p>Verify that a byte array is written successfully.</p>
	 */
	@Test

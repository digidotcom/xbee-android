...
public class CellularBLEDevice extends XBeeBLEDevice {
    /**
     * Class constructor. Instantiates a new {@code CellularBLEDevice} object
     ...
     *
     * @see #CellularBLEDevice(Context, String, String)
     * @see BluetoothDevice
     */
    public CellularBLEDevice(Context context, BluetoothDevice bleDevice, String password) {
     ...
     * @param password Bluetooth password (can be {@code null}).
     *
     * @see #CellularBLEDevice(Context, BluetoothDevice, String)
     */
    public CellularBLEDevice(Context context, String deviceAddress, String password) {

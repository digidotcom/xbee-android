 ...
 * @see ZigBeeBLEDevice
 */
public class Raw802BLEDevice extends XBeeBLEDevice {
    /**
     * Class constructor. Instantiates a new {@code Raw802BLEDevice} object for
     ...
     *
     * @see #Raw802BLEDevice(Context, String, String)
     * @see BluetoothDevice
     */
    public Raw802BLEDevice(Context context, BluetoothDevice bleDevice, String password) {
     ...
     * @param password Bluetooth password (can be {@code null}).
     *
     * @see #Raw802BLEDevice(Context, BluetoothDevice, String)
     */
    public Raw802BLEDevice(Context context, String deviceAddress, String password) {

 ...
 * @see ZigBeeBLEDevice
 */
public class DigiMeshBLEDevice extends XBeeBLEDevice {
    /**
     * Class constructor. Instantiates a new {@code DigiMeshBLEDevice} object
     ...
     *
     * @see #DigiMeshBLEDevice(Context, String, String)
     * @see BluetoothDevice
     */
    public DigiMeshBLEDevice(Context context, BluetoothDevice bleDevice, String password) {
     ...
     * @param password Bluetooth password (can be {@code null}).
     *
     * @see #DigiMeshBLEDevice(Context, BluetoothDevice, String)
     */
    public DigiMeshBLEDevice(Context context, String deviceAddress, String password) {
